...
public class Breakout_Game extends Application {
    ...
    public Scene setupGame (int width, int height, Paint background, Stage s, int currentLV, int bouncerSpeed) {
		...
		winningText = createText(winningText, r, WIDTH/6, 3*HEIGHT/4, "Congratualations! You Won!", 20);
    ...
    public void step (double elapsedTime, Stage s, int currentLV) {
        // update attributes
        myBouncer = myBouncer.myBouncerPos(elapsedTime, myPaddle, animation, s, currentLV, myBricks, bouncerSpeed, winningText, losingText);
